...
export default function SingleInput({ onResult }: SingleInputProps) {
  ...
  const statusIndicator = {
    idle: null,
    valid: <span className="text-xs font-medium text-green-600 dark:text-green-400">✅ 有効</span>,
    invalid: <span className="text-xs font-medium text-red-600 dark:text-red-400">❌ 無効</span>,
  };
  ...
  return (
    <div className="space-y-3">
      ...
      {/* バリデーションステータス */}
      <div id="phone-validation-status" className="min-h-[20px]" role="status" aria-live="polite">
        {status !== 'idle' && (
